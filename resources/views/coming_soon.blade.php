...
<html lang="en">
    ...
    <body>
        <div class="size1 bg0 where1-parent">
            <!-- Coutdown -->
            <div class="flex-c-m bg-img1 size2 where1 overlay1 where2 respon2" style="background-image: url('comingsoon/images/bg01.jpg');">
            ...
            <div class="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">
                <div class="wrap-pic1">
                    <img src="{{asset('comingsoon/images/icons/logo.png')}}" alt="LOGO">
                </div>
